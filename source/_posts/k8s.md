...
备注：docker部分功能需用3.10以上的 linux kernel 才能支持，CENTOS/RHEL6版本的linux内核都低于3.10，所以需要在CENTOS/RHEL6安装docker则需要升级内核版本。本文建议在CENTOS/RHEL7版本内使用docker。其它liunx支持的发行版包括请参考官方文档，这里不再阐述。    
